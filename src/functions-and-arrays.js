...
let array=['hello', 'bye']const findLongestWord=(array)=>{
  // if(!array){return}
  // if(array.length===1){return array}
    let longestWord='';
    array.forEach(function(word){      if(word.length>longestWord.length){
       longestWord=word}  }  )
    return longestWord
...
const numbersAvg = [2, 6, 9, 10, 7, 4, 1, 9];const averageNumbers = (array) => {
  let sum2 = 0;
...
const wordsArr = ['seat', 'correspond', 'linen', 'motif', 'hole', 'smell', 'smart', 'chaos', 'fuel', 'palace'];const averageWordLength = (array) => {
  let wordAvg = 0;
...
const doesWordExist = (array, word) => {  let exists = ''   array.forEach(function () {
